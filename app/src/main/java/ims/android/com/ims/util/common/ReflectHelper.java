...
//			Method method = objClass.getMethod(methodName);
            ...
            synchronized (mMethodMap) {
                ...
                //			Method method = objClass.getMethod(methodName, clazzes);
